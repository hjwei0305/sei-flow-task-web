          ...
          <Form style={{ maxWidth: '300px' }}>
              ...
              <Item>
                {getFieldDecorator('tenant', {
                  ...
                  <Input
                    ...
                    placeholder={formatMessage({id: 'flowtask_000066', defaultMessage: '租户账号'})}
                  />,
                )}
              </Item>
            )}
            ...
            <Item>
              {getFieldDecorator('password', {
                rules: [{ required: true, message: formatMessage({id: 'flowtask_000069', defaultMessage: '请输入密码!'}) }],
              })(
                <Input
              ...
              <Item>
                {getFieldDecorator('verifyCode', {
                  ...
                  rules: [
                    {
                      required: true,
                      message: formatMessage({id: 'flowtask_000071', defaultMessage: '请输入验证码!'}),
                    },
                  ],
                })(
                  <Input
                    ...
                    addonAfter={<img alt={formatMessage({id: 'flowtask_000072', defaultMessage: '验证码'})} onClick={this.handleVertify} src={verifyCode} />}
                  />,
                )}
              </Item>
            ) : null}
            <Item>
              {getFieldDecorator('locale', {
                ...
                <Select size="large" onChange={this.handlerLocaleChange}>
                  <Option value="zh-CN">{formatMessage({id: 'flowtask_000073', defaultMessage: '简体中文'})}</Option>
