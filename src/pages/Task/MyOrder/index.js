      ...
      },
      {
        ...
        render: (_, record) => {
          if (get(record, 'manuallyEnd') === true) {
            return <Tag color="magenta">{formatMessage({id: 'flowtask_000057', defaultMessage: '异常结束'})}</Tag>;
          }
          if (get(record, 'ended') === true) {
            return <Tag color="green">{formatMessage({id: 'flowtask_000058', defaultMessage: '审批完成'})}</Tag>;
          }
          return <Tag color="blue">{formatMessage({id: 'flowtask_000059', defaultMessage: '审批中'})}</Tag>;
        },
      },
      {
