...
const flowStatusData = {
  ended: { name: formatMessage({id: 'flowtask_000058', defaultMessage: '审批完成'}), code: 'ended' },
  inflow: { name: formatMessage({id: 'flowtask_000059', defaultMessage: '审批中'}), code: 'inflow' },
  abnormalEnd: { name: formatMessage({id: 'flowtask_000057', defaultMessage: '异常结束'}), code: 'abnormalEnd' },
};
    ...
    return (
      <>
        <FormItem label={formatMessage({id: 'flowtask_000015', defaultMessage: '单据编号'})}>
          ...
          })(<Input allowClear placeholder={formatMessage({id: 'flowtask_000030', defaultMessage: '单据编号关键字'})} />)}
        </FormItem>
        <FormItem label={formatMessage({id: 'flowtask_000017', defaultMessage: '单据说明'})}>
          ...
          })(<Input allowClear placeholder={formatMessage({id: 'flowtask_000031', defaultMessage: '单据说明关键字'})} />)}
        </FormItem>
    ...
    return (
      ...
      >
        ...
        <div className="footer">
          <Button onClick={this.handlerReset}>{formatMessage({id: 'flowtask_000034', defaultMessage: '重置'})}</Button>
